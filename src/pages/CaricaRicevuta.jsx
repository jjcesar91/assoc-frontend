...
//
// Regola di modifica: dopo aver caricato e confermato, finché si resta su questa
// pagina è possibile sostituire il file (PUT). Riaprendo il link in un secondo
// momento la ricevuta risulta in sola lettura.

const ACCEPT = '.pdf,.doc,.docx,.odt,.rtf,image/*';
const ACCEPT_LABEL = 'PDF, Word, LibreOffice/OpenDocument o immagine';
    ...
    return (
        <div style={styles.page}>
            <div style={styles.card}>
                ...
                {stato === 'loading' && (
                    <p style={styles.muted}>Verifica del link in corso…</p>
                )}
